...
POD_CIDR="10.52.0.0/16"                # Do NOT overlap with NODE/SVC/JOIN CIDR
POD_GATEWAY="10.52.0.1"
SVC_CIDR="10.53.0.0/16"                # Do NOT overlap with NODE/POD/JOIN CIDR
